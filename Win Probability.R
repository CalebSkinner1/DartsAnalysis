...
save(density_mid, file = "DartsAnalysis/Densities/density_mid.RData")
save(density_high, file = "DartsAnalysis/Densities/density_high.RData")
save(density_low, file = "DartsAnalysis/Densities/density_low.RData")
save(density_254, file = "DartsAnalysis/Densities/density_254.RData")
